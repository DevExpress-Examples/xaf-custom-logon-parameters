...
using EFCoreCustomLogonAll.WebApi.JWT;
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXafMiddleTier(Configuration, builder => {
            ...
            builder.ObjectSpaceProviders
                .AddSecuredEFCore()
                    .WithDbContext<EFCoreCustomLogonAll.Module.BusinessObjects.EFCoreCustomLogonAllEFCoreDbContext>((serviceProvider, options) => {
            ...
            builder.AddBuildStep(application => {
                application.ApplicationName = "SetupApplication.EFCoreCustomLogonAll";
